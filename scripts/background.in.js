...
(function (window) {
  ...
  window.importScripts("../js/intrinsic.js");
  window.importScripts("../js/basicTypesBundle.js");
  window.importScripts("../js/pattern+typeBundle.js");
  window.importScripts("../js/equalityBundle.js");
  window.importScripts("../js/pointBundle.js");
  window.importScripts("../js/collections.js");
  window.importScripts("../js/standardBundle.js");
  window.importScripts("../js/standard.js");
  window.importScripts("../js/sys.js");
  window.importScripts("../js/io.js");
  window.importScripts("../js/unicode.js");
  ...
  window.importScripts("../js/basic.js");
  window.importScripts("../js/scope.js");
  window.importScripts("../js/constantScope.js");
